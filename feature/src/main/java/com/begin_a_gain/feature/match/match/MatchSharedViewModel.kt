...
class MatchSharedViewModel @Inject constructor(
    ...
    private var _currentParticipants: MutableStateFlow<List<ParticipantInfo>> = MutableStateFlow(listOf())
    ...
    fun setCurrentMatch(amIHost: Boolean, participants: List<ParticipantInfo>) {
